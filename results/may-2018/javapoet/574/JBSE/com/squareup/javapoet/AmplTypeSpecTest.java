...
public final class AmplTypeSpecTest {
    ...
    public void typeVariableWithBounds() throws Exception {
        ...
        Assert.assertEquals(206701370, ((int) (((com.squareup.javapoet.TypeSpec)((com.squareup.javapoet.TypeSpec.Builder)((com.squareup.javapoet.TypeSpec)typeSpec).toBuilder()).build()).hashCode())));
        Assert.assertEquals("class Location<P extends java.lang.Number & java.lang.Comparable, Q extends java.lang.Number & java.lang.Comparable> {\n  P x;\n\n  @com.squareup.tacos.A Q y;\n}\n", ((com.squareup.javapoet.TypeSpec)typeSpec).toString());
        Assert.assertEquals(206701370, ((int) (((com.squareup.javapoet.TypeSpec)typeSpec).hashCode())));
