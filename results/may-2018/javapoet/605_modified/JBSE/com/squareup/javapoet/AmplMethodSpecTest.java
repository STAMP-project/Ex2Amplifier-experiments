...
public final class AmplMethodSpecTest {
    ...
    public void overrideEverything() throws Exception {
        ...
        Assert.assertEquals(922942018, ((int) (((com.squareup.javapoet.MethodSpec)method).hashCode())));
        ...
        Assert.assertEquals(922942018, ((int) (((com.squareup.javapoet.MethodSpec)((com.squareup.javapoet.MethodSpec.Builder)((com.squareup.javapoet.MethodSpec)method).toBuilder()).build()).hashCode())));
