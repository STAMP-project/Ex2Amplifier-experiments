...
public class AmplElementsTest {
    ...
    public void attributes() throws Exception {
        ...
        Assert.assertEquals("<p title=foo><p title=bar><p class=foo><p class=bar>", h);
        ...
        Assert.assertTrue(withTitle.isEmpty());
        int o_attributes__6 = withTitle.size();
        Assert.assertEquals(0, ((int) (o_attributes__6)));
        boolean o_attributes__7 = withTitle.hasAttr("title");
        Assert.assertFalse(o_attributes__7);
        boolean o_attributes__8 = withTitle.hasAttr("class");
        Assert.assertFalse(o_attributes__8);
        String o_attributes__9 = withTitle.attr("title");
        Assert.assertEquals("", o_attributes__9);
        Elements o_attributes__10 = withTitle.removeAttr("title");
        Assert.assertTrue(o_attributes__10.isEmpty());
        int o_attributes__11 = withTitle.size();
        Assert.assertEquals(0, ((int) (o_attributes__11)));
        int o_attributes__12 = doc.select("p[title]").size();
        Assert.assertEquals(0, ((int) (o_attributes__12)));
        Elements ps = doc.select("p").attr("style", "classy");
        Assert.assertTrue(ps.isEmpty());
        int o_attributes__17 = ps.size();
        Assert.assertEquals(0, ((int) (o_attributes__17)));
        ps.last().attr("style");
        ps.last().attr("class");
    }
}
