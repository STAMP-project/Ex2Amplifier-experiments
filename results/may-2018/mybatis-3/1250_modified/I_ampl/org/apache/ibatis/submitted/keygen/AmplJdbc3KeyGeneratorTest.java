...
public class AmplJdbc3KeyGeneratorTest {
    ...
    public void shouldErrorUndefinePropertylitString10() throws Exception {
        ...
        try {
            CountryMapper mapper = sqlSession.getMapper(CountryMapper.class);
            int o_shouldErrorUndefinePropertylitString10__7 = BDDCatchException.when(mapper).insertUndefineKeyProperty(new Country("Chi@na", "CN"));
    ...
    public void shouldErrorUndefinePropertylitString11() throws Exception {
        ...
        try {
            CountryMapper mapper = sqlSession.getMapper(CountryMapper.class);
            int o_shouldErrorUndefinePropertylitString11__7 = BDDCatchException.when(mapper).insertUndefineKeyProperty(new Country("China", "CN"));
