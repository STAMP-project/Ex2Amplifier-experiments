...
public class AmplExcludeFieldTest {
    ...
    public void testMuchExcludedEntity() throws Exception {
        ...
        Assert.assertEquals(1414100589, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
    ...
    public void testIt() throws Exception {
        ...
        Assert.assertEquals(1667685104, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
    ...
    public void testTaggedAndExcludedEntity() throws Exception {
        ...
        Assert.assertEquals(-1291015485, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
