...
public class AmplExcludeFieldTest {
    ...
    public void testMuchExcludedEntity() throws Exception {
        ...
        Assert.assertEquals(333726343, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
    ...
    public void testIt() throws Exception {
        ...
        Assert.assertEquals(95631473, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
    ...
    public void testTaggedAndExcludedEntity() throws Exception {
        ...
        Assert.assertEquals(-797320798, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
