...
public class AmplExcludeFieldTest {
    ...
    public void testIt() throws Exception {
        ...
        Assert.assertEquals(1652618140, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
    ...
    public void testTaggedAndExcludedEntity() throws Exception {
        ...
        Assert.assertEquals(1513426768, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
