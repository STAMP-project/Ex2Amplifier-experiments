...
public class AmplExcludeFieldTest {
    ...
    public void testIt() throws Exception {
        ...
        Assert.assertEquals(1491880763, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
    ...
    public void testTaggedAndExcludedEntity() throws Exception {
        ...
        Assert.assertEquals(1105990798, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
