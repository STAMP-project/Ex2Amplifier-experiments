...
public class AmplExcludeFieldTest {
    ...
    public void testMuchExcludedEntity() throws Exception {
        ...
        Assert.assertEquals(905636395, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
    ...
    public void testIt() throws Exception {
        ...
        Assert.assertEquals(1957839178, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
    ...
    public void testTaggedAndExcludedEntity() throws Exception {
        ...
        Assert.assertEquals(-967170590, ((int) (((java.util.List)((io.protostuff.runtime.RuntimeSchema)schema).getFields()).hashCode())));
