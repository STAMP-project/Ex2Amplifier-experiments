...
public class AmplObjectSchemaTest {
    ...
    static AmplObjectSchemaTest.Bean fill(AmplObjectSchemaTest.Bean bean) {
        ...
        EnumMap<AmplObjectSchemaTest.Order, AmplObjectSchemaTest.Item> orderMap = new EnumMap<AmplObjectSchemaTest.Order, AmplObjectSchemaTest.Item>(AmplObjectSchemaTest.Order.class);
        ...
        IdentityHashMap<AmplObjectSchemaTest.Item, AmplObjectSchemaTest.Item> identityMap = new IdentityHashMap<AmplObjectSchemaTest.Item, AmplObjectSchemaTest.Item>();
        ...
        IdentityHashMap<AmplObjectSchemaTest.Order, AmplObjectSchemaTest.Item> anotherIdentityMap = new IdentityHashMap<AmplObjectSchemaTest.Order, AmplObjectSchemaTest.Item>();
